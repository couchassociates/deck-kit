...
1. Fetch `PLAYER.md`, `template.html`, `player.css`, `player.js` from `https://raw.githubusercontent.com/couch-associates/deck-kit/main/` (replace `main` with a branch name if the person gave one).
